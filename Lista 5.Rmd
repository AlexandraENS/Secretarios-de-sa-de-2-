...
Apesar da regressão linear ser a mais utilizada e recomendada para testar correlações entre variáveis, nem sempre ela é a ideal sem os devidos ajustes. No caso apresentado, o mais adequado seria ter outras variáveis, ou uma possível variável de controle e que fosse realizada uma regressão linear múltipla. Por isso, nossos resultados apresentam limitações e a utilização naõ adequadra do método estatítico também. 
